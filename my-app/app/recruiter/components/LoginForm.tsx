...
export function LoginForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="mx-auto max-w-md space-y-6 rounded-2xl border border-white/10 bg-white/[0.03] p-8"
    >
      ...
      <p className="text-center text-xs text-zinc-600">
        Uses your row in <code className="text-zinc-500">applicants</code>{" "}
        (username + password).
      </p>
    </form>
  );
